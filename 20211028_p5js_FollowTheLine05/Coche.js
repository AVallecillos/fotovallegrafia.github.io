function Coche(x,y,v,c){
	...
	this.mover = function(){
		...
		if(this.l == "215" && this.m != "215" && this.r != "215"){
			this.v = v;
			this.angulo = this.angulo + 3*(2*PI/360); //gira a la derecha
		}

		if(this.l == "215" && this.m == "215" && this.r != "215"){
			this.v = v-0.5;
			this.angulo = this.angulo + 8*(2*PI/360); //gira mucho a la derecha
		}

		if(this.l != "215" && this.m != "215" && this.r == "215"){
			this.v = v;
			this.angulo = this.angulo - 3*(2*PI/360); //gira a la izquierda
		}

		if(this.l != "215" && this.m == "215" && this.r == "215"){
			this.v = v-0.5;
			this.angulo = this.angulo - 8*(2*PI/360); //gira mucho a la izquierda
		}

		if(this.l == "215" && this.m == "215" && this.r == "215"){
			this.v = 0;
			this.angulo = this.angulo - 8*(2*PI/360); //para
		}
